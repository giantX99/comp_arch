...
void init_memory();
void load_program();
char * decoderEX(uint32_t ir);	/*ADDED THIS*/
char * decoderOP(uint32_t ir); /*ADDED THIS*/
uint32_t decoderRD(uint32_t ir); /*ADDED THIS*/
uint32_t decoderRS1(uint32_t ir); /*ADDED THIS*/
uint32_t decoderWild(uint32_t ir); /*ADDED THIS*/
